...
public class ImageLoader {
    ...
    private static class ImageLoaderImpl implements IImageLoader {
        ...
        public void asyncLoadImage(String path, IAsyncLoadImgListener imgListener) {
            Bitmap bitmap = null;
        ...
        public void cancelLoad(String paramString, IAsyncLoadImgListener paramIAsyncLoadImgListener) {
            Log.d("DefaultImageLoader", "default imageloader ignore cancel");
        }

        public void asyncLoadImage(String path, byte[] byteData, int offset, int length, IAsyncLoadImgListener imgListener) {
